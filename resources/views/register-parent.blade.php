      ...
      <div class="col-12 p-0">
         <div>
            <div class="theme-form">
               <form id="registrationForm" action="{{route('register.new')}}" method="POST">
                  @csrf
               <div class="wizard-4" id="wizard">
                  
                  <ul>
                     <li><a class="logo text-start ps-0" href="#"><img class="img-fluid for-light" src="{{asset('assets/images/logo/logoidzmir.png')}}" style="width: 150px" alt="looginpage"><span style="color: #5c5c5c; font-weight:500; font-size:25px">Registration</span></a></li>
                     <li>
                        <a href="#step-1">
                           <h4>1</h4>
