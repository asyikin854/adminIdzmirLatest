...
Route::get('/childSchedule/{child_id}/{package_id}', [RegisterController::class, 'childScheduleView'])->name('childSchedule.view');
...
Route::get('/chip/callback', [PaymentController::class, 'handleCallback'])->name('payment.callback-parent');
...
//end of idzmirKidsHub page route.. Below is the original template route
...
//Child route to display related to analytic
// Corrected Route
