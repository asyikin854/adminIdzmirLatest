<?php
    ...
    class RegisterController extends Controller
    {
        ...
        public function childScheduleView($child_id, $package_id)
        {
            ...
            // Fetch all slots starting from one day ahead until the end of the current month
    ...
    public function childSchedule(Request $request, $child_id, $package_id)
    {
        ...
        // Loop through selected slots and determine the base price (based on weekday or weekend)
        foreach ($selectedSlots as $index => $slotData) {
            ...
            ChildSchedule::create([
                'child_id' => $child_id,
                'session' => $totalSessions, // Number of sessions
